export const ru = {
  ...
  HELP: (
    ...
    + '2) Укажите сколько клипов сделать (по умолчанию 3, 15–25 сек каждый).\n'
    + '3) Выберите тренд/хэштеги (или пропустите).\n'
    + '4) Я соберу клипы с озвучкой (англ.), сабами и верну вам.\n\n'
  ...
  ASK_MODE: (
    ...
    + '1) Топ моменты — автоматически найду интересные моменты (укажите количество клипов)\n'
    + '2) Определенный кусок — вы укажете начало и конец отрезка\n'
    + '3) Весь материал — обрабатывать весь материал\n'
    + '4) Просто скачать — скачаю видео без обработки\n'
    + '5) Только звук — скачаю аудио в MP3\n\n'
    + 'Напишите 1, 2, 3, 4 или 5'
  ),
  INVALID_MODE: (
    'Пожалуйста, выберите 1 (топ моменты), 2 (определенный кусок), '
    + '3 (весь материал), 4 (просто скачать) или 5 (только звук).'
  ),
  ...
  ASK_TRENDS: 'Хочешь подсмотреть тренды для хэштегов? Напиши: да/нет. Если да — я предложу варианты.',
  TREND_OPTIONS: 'Топ трендов: {items}\nВыбери один номер или напиши свои хэштеги.',
